...
# could skip this step since they are probably the same lists - double check
...
cols_to_drop = ['SEQN','LBXGH','LBXSGL','PHAFSTHR','DIQ050','DIQ160','DIQ170','DIQ180','SDDSRVYR','PHDSESN']
